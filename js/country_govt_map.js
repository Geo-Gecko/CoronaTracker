  ...
  axios.get(url)
    .then(responseArrs => {
      ...
      if (element.id === "fiscal") {
        ...
        var african_data1 = L.geoJSON(null, {
          onEachFeature: forEachFeature2,
          style: stylefiscal
        }).addTo(map);

        african_data1.addData(africa_data);

        african_data1.on("click", onFeatureGroupClick);
        ...
        african_data1.eachLayer(function(layer) {
